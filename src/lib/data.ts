...
export const products: Product[] = [
  {
    ...
    price: 85,
    description:
      'Premium leather sneakers with a minimalist design and comfortable sole.',
    category: 'Shoes',
    image:
  ...
  },
  {
    ...
    price: 35,
    description:
      'Soft organic cotton t-shirt with a perfect fit for everyday wear.',
    category: 'Shirts',
    image:
...

  {
    ...
    price: 120,
    description:
      'Lightweight and breathable shoes designed for long-distance running comfort.',
    category: 'Shoes',
    image:
  ...
  },
  {
    ...
    price: 65,
    description:
      'Warm and durable flannel shirt, perfect for layering in cooler weather.',
    category: 'Shirts',
    image:
  ...
  },
  {
    ...
    price: 399,
    description:
      'Advanced health tracking, cellular connectivity, and stunning OLED display.',
  ...
  },
  {
    ...
    price: 150,
    description:
      'Handcrafted genuine leather bag with spacious compartments for your laptop and daily essentials.',
  ...
  },
  {
    ...
    price: 95,
    description:
      'Timeless denim jacket with a rugged finish and functional pockets.',
    category: 'Shirts',
    image:
